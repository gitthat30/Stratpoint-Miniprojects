...
import stratpoint.samuelnieva.EntityLayer.Biography;
import stratpoint.samuelnieva.EntityLayer.Book;
import stratpoint.samuelnieva.EntityLayer.Manga;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        LibraryServiceIMPL l = new LibraryServiceIMPL(books);
     ...
     */
    public static void addSampleBooks(LibraryServiceIMPL l) {
        //Test Data
